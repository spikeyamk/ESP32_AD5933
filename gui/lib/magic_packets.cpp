...
namespace MagicPackets {
	namespace Debug {
		namespace Command {
			...
			/*
			const std::array<std::array<uint8_t, 23>, 5> chunks { 
				start,
	...
	namespace FrequencySweep {
		namespace Command {
			...
			/*
			const std::array<std::array<uint8_t, 23>, 10> chunks {
