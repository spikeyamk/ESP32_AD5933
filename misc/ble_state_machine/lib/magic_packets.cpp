...
namespace MagicPackets {
	...
	namespace FrequencySweep {
		...
		namespace Condition {
			/*
			constinit const std::array<uint8_t, 23> data_valid_false {
				0x6a, 0x45, 0x00, 0xbb, 0xdf, 0xa5, 0xb2, 0x89, 
				0x77, 0x0b, 0x56, 0xa6, 0x05, 0x3f, 0x73, 0xdb, 
				0xb6, 0x6d, 0x2f, 0xb6, 0x69, 0x41, 0x1c, 
			};
