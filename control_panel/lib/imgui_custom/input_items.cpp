...
namespace ImGui {
    ...
    bool InputScalarWithCallback(const char* label, ImGuiDataType data_type, void* p_data, const void* p_step, const void* p_step_fast, const char* format, bool text_input, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback) {
    ...
    bool InputFloat(const char* label, float* v, float step, float step_fast, const char* format, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback) {
        return ImGui::InputScalarWithCallback(label, ImGuiDataType_Float, (void*)v, (void*)(step > 0.0f ? &step : NULL), (void*)(step_fast > 0.0f ? &step_fast : NULL), format, true, flags, callback);
    }
    ...
    bool Input_uint32_t_WithCallback(const char* label, uint32_t* v, uint32_t step, uint32_t step_fast, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback) {
        const char* format = (flags & ImGuiInputTextFlags_CharsHexadecimal) ? "%08X" : "%u";
        return ImGui::InputScalarWithCallback(label, ImGuiDataType_U32, (void*)v, (void*)(step > 0 ? &step : NULL), (void*)(step_fast > 0 ? &step_fast : NULL), format, true, flags, callback);
    }
    ...
    bool Input_uint32_t_WithCallbackTextReadOnly(const char* label, uint32_t* v, uint32_t step, uint32_t step_fast, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback) {
        const char* format = (flags & ImGuiInputTextFlags_CharsHexadecimal) ? "%08X" : "%u";
        return ImGui::InputScalarWithCallback(label, ImGuiDataType_U32, (void*)v, (void*)(step > 0 ? &step : NULL), (void*)(step_fast > 0 ? &step_fast : NULL), format, false, flags, callback);
    }
}