...
cmake_binary_dir_path = os.path.abspath(sys.argv[1])
header(os.path.join(cmake_binary_dir_path, os.path.relpath("include/legal/legal.hpp")))
source(os.path.join(cmake_binary_dir_path, os.path.relpath("lib/legal.cpp")), submodule_paths)