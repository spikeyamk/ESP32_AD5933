            ...
            namespace Connect {
                ...
                int sync_scan() {
                    ...
                    try {
                        ...
                        std::cout << "ERROR: BLE_Client::Tests::Thread::Connect::sync_scan: exception: " << e.what() << std::endl;
                        shm->cmd.send_killer(BLE_Client::StateMachines::Killer::Events::kill{});
                        return -5;
                    }
...
int main() {
    return Trielo::trielo<BLE_Client::Tests::Thread::Connect::sync_scan>(Trielo::OkErrCode(0));
}